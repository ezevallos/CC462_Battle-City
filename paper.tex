...
Clients are only in charge of sending orders for the server to execute and . 
...
For the implementation of the game, we are using a multithreaded approach in the 
